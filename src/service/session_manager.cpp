...
void SessionManager::RecordCreateFailureSession(
  ...
  vibe::session::SessionSnapshot snapshot{
      ...
      .signals = vibe::session::SessionSignals{
          ...
          .last_git_change_at_unix_ms = std::nullopt,
          .last_controller_change_at_unix_ms = std::nullopt,
          .attention_since_unix_ms = now_unix_ms,
          .pty_columns = std::nullopt,
          .pty_rows = std::nullopt,
          .current_sequence = current_sequence,
          .recent_file_change_count = 0,
          .supervision_state = vibe::session::SupervisionState::Stopped,
          .attention_state = vibe::session::AttentionState::ActionRequired,
          .attention_reason = vibe::session::AttentionReason::SessionError,
