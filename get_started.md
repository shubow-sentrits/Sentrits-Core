...
- Sentrits launches provider and direct-exec sessions through the configured interactive login shell by default
...
- common causes:
  ...
  - an interactive login shell prints warnings even though it exits successfully
